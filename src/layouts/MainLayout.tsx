          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
              ...
              <motion.a 
                ...
                title="LinkedIn"
                onMouseEnter={(e) => e.currentTarget.style.filter = 'drop-shadow(0 0 8px rgba(0, 119, 181, 0.8))'}
                onMouseLeave={(e) => e.currentTarget.style.filter = 'none'}
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
              ...
              <motion.a 
                ...
                title="GitHub"
                onMouseEnter={(e) => e.currentTarget.style.filter = 'drop-shadow(0 0 8px rgba(255, 255, 255, 0.8))'}
                onMouseLeave={(e) => e.currentTarget.style.filter = 'none'}
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
              ...
              <motion.a 
                ...
                title="Instagram"
                onMouseEnter={(e) => e.currentTarget.style.filter = 'drop-shadow(0 0 8px rgba(225, 48, 108, 0.8))'}
                onMouseLeave={(e) => e.currentTarget.style.filter = 'none'}
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
